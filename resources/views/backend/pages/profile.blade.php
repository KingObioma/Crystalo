                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <div>
                            <img class="wd-100 rounded-circle"
                                ...
                                alt="profile">
                            <span class="h4 ms-3">Administrator</span>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('store.profile') }}" class="forms-sample"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Name</label>
                                <input type="text" name="name" class="form-control" id="exampleInputUsername1"
                                    autocomplete="off" value="{{ $userData->name }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="position" class="form-control" id="exampleInputUsername1"
                                    autocomplete="off" value="{{ $userData->position }}">
                            </div>
