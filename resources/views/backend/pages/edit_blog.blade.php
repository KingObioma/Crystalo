            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.blog') }}" id="myForm"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="title" class="form-control" required rows="3">{{ $blog->title }}</textarea>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <img src="{{ !empty($blog->blog_thumbnail) ? asset('upload/blog_images/' . $blog->blog_thumbnail) : asset('upload/no_image.jpg') }}"
                                            style="width:80px;height:80px" alt="blog Thumbnail" id="mainThumbnail">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <img src="{{ !empty($blog->image_1) ? asset('upload/blog_images/' . $blog->image_1) : asset('upload/no_image.jpg') }}"
                                            style="width:80px;height:80px" alt="blog Image1" id="image1">
                                    </div>
                                </div><!-- Col -->
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <img src="{{ !empty($blog->image_2) ? asset('upload/blog_images/' . $blog->image_2) : asset('upload/no_image.jpg') }}"
                                            style="width:80px;height:80px" alt="blog Image2" id="image2">
                                    </div>
                                </div><!-- Col -->
                            </div><!-- Row -->
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="quote" class="form-control" required rows="4">{{ $blog->quote }}</textarea>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="tags" class="form-control" required rows="4">{{ $blog->tags }}</textarea>
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="paragraph_1" class="form-control" required rows="5">{{ $blog->paragraph_1 }}</textarea>
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="paragraph_2" class="form-control" required rows="5">{{ $blog->paragraph_2 }}</textarea>
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="paragraph_3" class="form-control" required rows="5">{{ $blog->paragraph_3 }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="category" value="Modern" class="form-check-input"
                                        {{ $blog->category == 'Modern' ? 'checked' : '' }} id="radioModern">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="category" value="Contemporary" class="form-check-input"
                                        {{ $blog->category == 'Contemporary' ? 'checked' : '' }}
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="category" value="Traditional"
                                        ...
                                        {{ $blog->category == 'Traditional' ? 'checked' : '' }} id="radioTraditional">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="category" value="Retreat" class="form-check-input"
                                        {{ $blog->category == 'Retreat' ? 'checked' : '' }} id="radioRetreat">
