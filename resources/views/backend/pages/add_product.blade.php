                        ...
                        <form method="post" action="{{ route('store.product') }}" id="myForm"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6" style="margin-top: 25px;">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="expected_delivery" class="form-control" required>
                                    </div>
                                </div><!-- Col -->
                            </div><!-- Row -->
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="long_description" class="form-control" required rows="8"></textarea>
