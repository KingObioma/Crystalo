  ...
  <section class="working-process-style2-area"
      style="background-image:url({{ asset('frontend/images/parallax-background/working-process-bg-style3.jpg') }});">
      <div class="container">
          <div class="sec-title">
              ...
              <div class="col-xl-12 col-lg-12">
                  <div class="working-process-carousel owl-carousel owl-theme">
                      ...
                      <div class="single-working-process-style2">
                          ...
                          <div class="inner">
                              <h3>Specification</h3>
                              <p>Owing to the claims of duty or business will frequently occur that pleasures have to be
                                  repudiated and annoyances.</p>
                          </div>
                      </div>
                      <!--End Single Working Process-->
                      <!--Start Single Working Process-->
                      <div class="single-working-process-style2">
                          ...
                          <div class="inner">
                              <h3>Execution</h3>
                              <p>Same as saying through shrinking from toil and pain. These cases are perfectly simple
