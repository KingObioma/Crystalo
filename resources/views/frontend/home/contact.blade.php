 ...
 <section class="contact-details-area">
     ...
     <div class="parallax-background"
         style="background-image:url({{ asset('frontend/images/parallax-background/contact-details-bg.html') }});">
     </div>
     <div class="container">
         <div class="row">
             <div class="col-xl-12">
                     ...
                     <div class="row">
                         <div class="col-xl-6 col-lg-6">
                             <div class="content-info-box"
                                 style="background-image:url({{ asset('frontend/images/parallax-background/contact-info-box-bg.jpg') }});">
